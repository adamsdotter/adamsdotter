<?php
	$title = 'Contact Patricia Adamsson, aka Mjau';
	$description = 'How to get in contact with Patricia Adamsson.';
	$canonical = 'http://www.adamsdotter.se/contact/';
	$pageName = 'mjau contact';
